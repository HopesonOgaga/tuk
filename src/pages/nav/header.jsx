    ...
    <header className="sticky top-0 z-50 bg-yellow-200 border-b shadow-md border-b-4 border-b-black/10 capitalize">
      <div className="flex items-center justify-between px-6 py-4 relative z-50 bg-yellow-200">
        ...
        <div className="flex items-center gap-3">
          <div className="w-24 h-12 bg-slate-900 rounded-full flex items-center justify-center">
            <span className="italic text-white font-bold text-lg">
              tok<span className="text-orange-400">tub</span>
            </span>
          </div>
        </div>
        ...
        <nav className="hidden md:block">
          <ul className="flex gap-6 font-medium text-slate-900 italic">
            <li><a href="/" className="px-4 py-2 rounded-md hover:bg-amber-100 transition-colors">Home</a></li>
            <li><a href="#about" className="px-4 py-2 rounded-md hover:bg-amber-100 transition-colors">about</a></li>
            <li><a href="#artist" className="px-4 py-2 rounded-md hover:bg-amber-100 transition-colors">artists</a></li>
          </ul>
        </nav>
      ...
      >
        <ul className="flex flex-col gap-2 p-6 font-medium italic">
          <li>
            <a href="/" onClick={() => setOpen(false)} className="block px-4 py-3 rounded-md hover:bg-amber-200 transition-colors">Home</a>
          </li>
          <li>
            <a href="#about" onClick={() => setOpen(false)} className="block px-4 py-3 rounded-md hover:bg-amber-200 transition-colors">About</a>
          </li>
          <li>
            <a href="#artist" onClick={() => setOpen(false)} className="block px-4 py-3 rounded-md hover:bg-amber-200 transition-colors">Artists</a>
          </li>
          <li>
